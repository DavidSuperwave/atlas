...
-- ============================================================
-- PART 6: SCRAPE QUEUE & BROWSER SESSIONS
-- ============================================================
-- Source: add_scrape_queue.sql
-- Queue system for sequential scrape processing
...
AND table_name IN ('user_profiles', 'credit_transactions', 'gologin_profiles', 'user_gologin_profiles', 'scrape_queue', 'browser_sessions')
ORDER BY table_name;
